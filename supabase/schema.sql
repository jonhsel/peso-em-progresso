...
-- ---------------------------------------------------------
-- 13. Atividade Física
-- Ver supabase/migrations/0015_activity.sql
-- ---------------------------------------------------------
...
-- Seed de 2 tipos padrão no signup. 3º trigger AFTER INSERT em auth.users,
-- coexistindo com on_auth_user_created (handle_new_user) e
-- on_auth_user_created_goals (handle_new_user_goals) — independentes entre
-- si, ordem de execução (alfabética por nome) não importa.
